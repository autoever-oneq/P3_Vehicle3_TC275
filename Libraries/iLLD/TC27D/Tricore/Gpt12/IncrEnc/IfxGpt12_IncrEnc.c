...
IFX_STATIC void IfxGpt12_IncrEnc_updateSpeedFromT4(IfxGpt12_IncrEnc *driver, sint32 newPosition);
/******************************************************************************/
...
{
    //test_speed = driver->speed; 여기서도 0
    return driver->speed;
}
...
boolean IfxGpt12_IncrEnc_init(IfxGpt12_IncrEnc *driver, const IfxGpt12_IncrEnc_Config *config)
{
    ...
    {
        /* T2 Configuration */
        IfxGpt12_T4_setMode(gpt12, IfxGpt12_Mode_incrementalInterfaceEdgeDetection);

        switch (config->base.resolutionFactor)
        {
        case IfxStdIf_Pos_ResolutionFactor_twoFold:
            IfxGpt12_T4_setIncrementalInterfaceInputMode(gpt12, IfxGpt12_IncrementalInterfaceInputMode_bothEdgesTxIN);
            break;
        case IfxStdIf_Pos_ResolutionFactor_fourFold:
        ...
        IfxGpt12_T4_setDirectionSource(gpt12, IfxGpt12_TimerDirectionSource_external);
        IfxGpt12_T4_setTimerDirection(gpt12, config->base.reversed ? IfxGpt12_TimerDirection_down : IfxGpt12_TimerDirection_up);
...
IFX_STATIC void IfxGpt12_IncrEnc_updateFromT4(IfxGpt12_IncrEnc *driver)
{
    ...
    IfxGpt12_IncrEnc_updateSpeedFromT4(driver, newPosition);
    driver->rawPosition = newPosition;
}
